/**
 * Minimaler Express-Router f�r OPC UA Verbindungs-Konfigurationen
 ...
 * - Logger-Service (user 'logger') muss Leserechte f�r config und Schreibrechte f�r PKI-Ordner haben
 */
