...
# Usage: die Datei ist nur Dokumentation + kann direkt ausgeführt werden, um Beispiel‑Aufrufe
#        zu testen (set-eth0-static.sh muss im selben Verzeichnis liegen oder mit vollem Pfad aufgerufen werden).
#
